...
8. Regra de Ouro IA: Se a busca ({target_keyword}) for relacionada a Inteligência Artificial (ex: "AI Coder", "Engenheiro de Prompt", "Consultor de IA"), a vaga DEVE citar explicitamente o uso de ferramentas de IA (ChatGPT, Cursor, Copilot, LLMs, Midjourney) como parte CENTRAL do trabalho. Se for uma vaga tradicional de TI onde IA é apenas um bônus ou não é mencionada, REPROVE sumariamente (vaga_corresponde_ao_cargo=false, aprovado=false).
